...
const ContactForm = () => {
  ...
  return (
    <div id="contact" className="py-16 sm:py-20 bg-gray-50 rounded-xl mt-2 shadow p-6">
    <div className="text-center px-4">
      ...
      <p className="text-base sm:text-lg md:text-xl text-gray-900 mt-4 mb-6">
        Ready to start your next project with us? Send us a quick message and
        we will get back to you<br className="hidden sm:block" /> as soon as possible!
      </p>
    </div>
    ...
    <form
      ref={formRef}
      onSubmit={sendEmail}
      className="w-full sm:w-4/5 md:w-2/3 lg:w-1/2 mx-auto space-y-6 bg-white px-4 sm:px-8 py-8 rounded-xl shadow-xl"
    >
